...
void Init_Game(Game_Info * game_info, Block_Info * block_info, Map_Info * map_info, UI_Info * ui_info);	//게임 시작
void Excute_Game(Game_Info * game_info, Block_Info * block_info, Map_Info * map_info, UI_Info * ui_info); //게임 실행
...
void Init_Game(Game_Info * game_info, Block_Info * block_info, Map_Info * map_info, UI_Info * ui_info) { //게임 시작
	...
	srand((unsigned)time(NULL)); //난수표생성, block의 type이 랜덤으로 정해지기 때문에
